...
public class TaskServiceImpl implements TaskService {
    ...
    @Override
    public List<TaskDto> findByUserNameAndCategoryName(FindTaskByUserNameAndCategoryNameDto model) {
        var tasks = taskRepository.findByUserNameAndCategoryName(model.getUserName(),
                model.getCategoryName());
        return tasks.stream().map(taskMapper::toDomain).collect(Collectors.toList());
    }
}
